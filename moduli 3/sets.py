...
union_result_method=set.union(set2)
...
intersection_operator= set1.intersection(set2)
...
differnce_method= set1.difference(set2)
differnce_operator= set1.difference(set2)
print("difference of set1 and set2 using difference method:", differnce_method)
print("difference of set1 and set2 using difference operator:", differnce_operator)
